                ...
                <div id="YourName_YourClass" class="gap-5 flex mt-4">
                    <div id="YourName" class="w-full">
                        <label for="">
                            ...
                            <input type="text" v-model="nameInput" class="mb-0 h-[40px] rounded-md w-full outline-none border-2 focus:border-blue-500 px-4">
                        </label>
                    </div>
                    <div id="YourName" class="w-full">
                        <label for="">
                            <span class="pl-3">Lớp</span>
                            <input type="text" v-model="classInput" class="mb-0 h-[40px] rounded-md w-full outline-none border-2 focus:border-blue-500 px-4">
                        </label>
                    </div>
                </div>
                <div id="YourName_YourClass" class="gap-5 flex mt-4">
                    <div id="YourName" class="w-full">
                        <label for="">
                            ...
                            <select ref="selectGender" @change="genderInput = $event.target.value" class="mb-0 h-[40px] rounded-md w-full outline-none border-2 focus:border-blue-500 px-4">
                    ...
                    <div id="Gender" class="w-full">
                        <label for="">
                            ...
                            <input type="date" ref="birthdayEle" v-model="birthdayInput" class="mb-0 h-[40px] rounded-md w-full outline-none border-2 focus:border-blue-500 px-4">
                        </label>
                    </div>
                </div>
            </form>
