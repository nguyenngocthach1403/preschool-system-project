<template>
  <div
    class="bg-[#F4F4F4] w-[300px] h-[320px] rounded-[10px] grid shadow-card grid-rows-2 mt-[10px] mx-[10px] border-2"
  >
    <!--Avatar & Status -->
    <div id="head" class="p-[8px] rounded-[16px] relative">
      <div
        class="status text-[10px] absolute bg-white top-[12px] left-[12px] px-[8px] rounded-[10px] h-[25px] content-center"
      ...
      <div class="absolute bottom-3 left-3 flex">
        <!--Class Type-->
        <div
          class="bg-white text-[13px] px-[8px] h-[20px] content-center rounded-[10px]"
        >
          {{ classData.type }}
        </div>
        <!--Session-->
        <div
          class="bg-white text-[13px] ml-1 px-[8px] h-[20px] content-center rounded-[10px]"
        >
          {{ classData.session }}
        </div>
      </div>
